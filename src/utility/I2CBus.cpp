...
bool I2CBus::writeCommand(uint8_t address, uint8_t subAddress) {
...
// Wire.h read and write protocols
bool I2CBus::writeByte(uint8_t address, uint8_t subAddress, uint8_t data) {
  bool function_result = false;
  Wire.beginTransmission(address);  // Initialize the Tx buffer
  Wire.write(subAddress);           // Put slave register address in Tx buffer
...
// Wire.h read and write protocols
bool I2CBus::writeBytes(uint8_t address, uint8_t subAddress, uint8_t *data, uint8_t length) {
  bool function_result = false;
...
bool I2CBus::readByte(uint8_t address, uint8_t *result) {
...
bool I2CBus::readByte(uint8_t address, uint8_t subAddress,uint8_t *result) {
  uint8_t data; // `data` will store the register data
...
bool I2CBus::readBytes(uint8_t address, uint8_t subAddress, uint8_t count,uint8_t * dest) {
  #ifdef I2C_DEBUG_TO_SERIAL
...
bool I2CBus::readBytes(uint8_t address, uint8_t count,uint8_t * dest) {
  uint8_t i = 0;
...
void I2CBus::scanID(bool *result) {
