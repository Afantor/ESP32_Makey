...
void loop() {
  ...
  float test = 67.125;
  tft.drawFloat(test, 4, 120, 120, 6);
  tft.drawString(dtostrf(test,4,4,tmp), 120, 200, 6);

  delay(1000);
  tft.fillScreen(TFT_BLACK);
  
  test = -0.555555;
  tft.drawFloat(test, 3, 120, 120, 6);
    tft.drawString(dtostrf(test,2,2,tmp), 120, 200, 6);
  ...
  test = 9999999;
  tft.drawFloat(test, 0, 120, 120, 6);
  tft.drawString(dtostrf(test,4,4,tmp), 120, 200, 6);
  delay(1000);
